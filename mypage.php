    ...
    <body>
        ...
        <div class="responsive-wrapper">
            ...
            <div class="sub-header">
                <span>원하시는 정보를 수정해주세요.</span>
                <!-- ☎️ -->
            </div>
            <div class="content-header">
            <form id="update" method="post" action="./update.php"></form>
            <form id="confirm-pw" method="post" action="./confirm_pw.php"></form>
            <div class="mail-form">
                    <table>
                        <tr>
                            <td id="tag">프로필수정</td>
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" id="crop_and_upload" class="btn btn-primary">완료</button>
                        ...
                        <tr>
                            <td id="tag">이름</td>
                            <td id="input">
                                <input type="text" name="name-update" minlength="2" maxlength="10" value = "<?php echo $g_name; ?>" placeholder="이름을 입력하세요" form="update">
                            </td>
                        </tr>
                        <tr>
                            <td id="tag">아이디</td>
                        ...
                        <tr class="pw">
                            <td id="tag">현재 비밀번호</td>
                            <td id="input2">
                                <input type="password" name="con_pw" placeholder="Password" form="confirm-pw" minlength="8" maxlength="20"> 
                                <input type="submit" class="button2" value="비밀번호 확인" form="confirm-pw">                                
                            </td>
                        </tr>
                        <tr class="new_pw">
                            <td id="tag">새 비밀번호</td>
                            <td id="input">
                                <input type="password" name="pw-update" placeholder="Password" form="update" minlength="8" maxlength="20">
                            </td>
                        </tr>
                        <tr class="new_pw">
                            <td id="tag">새 비밀번호 확인</td>
                            <td id="input">
                                <input type="password" name="pw-update2" placeholder="Password" form="update" minlength="8" maxlength="20">
                            </td>
                        </tr>
                        <tr>
                            <td id="tag">이메일</td>
                            <td id="input">
                                <input type="email" name="email-update" placeholder="Email" value="<?php echo $g_email;?>" form="update">
                            </td>
                        </tr>
                    </table>
                    <input type="submit" class="button" value="수정하기" form="update">
                </div>
            </div>
...
<?php
    if ($confirm == 'OK') {
        ...
        document.getElementsByClassName('new_pw')[0].style.display = 'tabel-cell';
        document.getElementsByClassName('new_pw')[1].style.display = 'tabel-cell';
        </script>";
    } else {
        echo"<script type=\"text/javascript\">
        document.querySelector('.pw').style.display = 'tabel-cell';
        document.getElementsByClassName('new_pw')[0].style.display = 'none';
        document.getElementsByClassName('new_pw')[1].style.display = 'none';
        </script>";
    }
?>