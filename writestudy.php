...
<html class="html__responsive " lang="en">
    <head>
		...
		<link rel="stylesheet" href="css/writestudy.css?ver=4"/>
	...
	<body>
		...
		<main class="main">
			<div class="responsive-wrapper">
                ...
                <div class="sub-header">
                    <span>
                        <br>사진을 삽입하지 않으면 랜덤으로 사진이 삽입됩니다.
                        <br>내용을 작성하지 않으실 경우, 일기가 저장되지 않습니다.
                        <br>일기를 저장하고 싶지 않으실 경우, '저장하기' 버튼을 눌러 넘어가주세요!</span>
                </div>
				<div class="content">
					<div class="container">
						<div class="smallProfile">
							<div class="column1">
							  ...
							  <div class="column-inside">
								<a class="name" style="text-decoration-line:none; color:black; margin-left:0.75rem;"><?php echo $g_name; ?></a>
							  </div>
							</div>
							<!-- <div class="column2">
							  // <a class="hashtag2">
							  ...
							  <div class="hashtag2">
								  <form class="form">
									  <input type="text" class="field" name="field" placeholder="#hashtag" />
									  <button type="button" class="addbtn">+</button>
								  </form>
								  //<button class="addbtn">+</button> 
								  <ul class="list">
									  <li>
										  <span class="listName">힘들어</span>
									  </li>
									  <li>
										  <span class="listName">졸려</span>
									  </li>
								  </ul>
							  </div>
							</div> -->
						</div>
						<form id="save" method="POST" action="saveDiary.php"></form>
						<div class="boxcontent">
							  <div class="todayPhoto" style="width: 50%;">
								  <div class="pictureBox">
									  <!-- <a class="noimage" style="width:200px; height:200px;"></a> -->
                                        <!-- <div class="image"> -->
                                            <img src="css/img/insertPicture.png" id="picture" class="image">
                                            <!-- <img src="css/img/insertPicture.png" id="picture" class="image"> -->
                                        <!-- </div> -->
									  <!-- <label for="addPicture" class="pictureButton">사진 추가하기</label>
									  <input
										  type="file"
										  id="addPicture"
										  name="addPicture"
                                    ...
                                    <div class="row">
                                        <form method="post">
                                            <div class="buttonLine">
                                                <label for="upload_image" class="pictureButton">사진 추가하기</label>
                                            <input type="file" name="crop_image" class="crop_image" id="upload_image" onchange="readURL(this)" style="display: none;"/>
                                            </div>
                          ...
                          <?php
                                $connect = mysqli_connect("localhost","root","yewwey1105","newdb") or die ("Can't access DB");
                                $sql= "SELECT * FROM study where id='$id' ORDER BY endtime DESC LIMIT 1";
                                $confirm = mysqli_query($connect, $sql);             
                                $array = mysqli_fetch_array($confirm);
                                $g_time = $array['studytime'];
                                ?>
							    <div class="diary"style="width: 50%;">
                                    <div class="modal-header">
                                        <h2><?php echo $g_time; ?></h2>
                                        <input type="hidden" name="time" value="<?php echo $g_time; ?>" form="save">
                                    </div>
                                    <div class="diary-content">
                                        <textarea name="content" placeholder="내용을 입력하세요" form="save"></textarea>
                                    </div>
                                </div>
								  
						</div>
                        <div id="footer">
                            <input type="submit" class="saveButton" value="저장하기"form="save">
                        </div>
					</div>  
				</div>
                
                <!-- <a class="saveButton">저장하기</a> -->
            </div>
		...
		<!-- <script src="js/writestudy.js"></script> -->
        <script>
            // const input2 = document.querySelector('input[name="crop_image"]');
