    ...
    <body>
        ...
        <div class="responsive-wrapper">
            ...
            <div class="sub-header">
                <span><a herf="question.html">자주묻는 질문(FAQ)</a> 외에 궁금하신 점을 메일로 보내주세요.<br>📞 1234 - 1234</span>
                <!-- ☎️ -->
            </div>
            <?php
            ...
            <div class="content-header">
                <form class="mail-form" method="POST" action="mail.php">
                    <table>
                        <tr>
                            <td id="tag">작성자 메일 주소</td>
                            <td id="input">
                                <input type="text" name="address" placeholder="이메일 주소를 입력하세요" value="<?php echo $g_email;?>">
                            </td>
                        </tr>
                        <tr>
                            <td id="tag">제목</td>
