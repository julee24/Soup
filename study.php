...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/study.css?ver=2"/>
        <title>공부하기</title>
    </head>
    <body>
        <header class="header">
        ...
        <div class="responsive-wrapper">
            ...
            <form id="studyTime" method="post" action="recode.php"></form>
            <div class="sub-header">
                <span>오늘도 함께 목표를 향해 열심히 달려갑시다!
                    <br>오른쪽 '시작하기'를 누르시고 공부할 것(책, 종이, 패드 등)과 손이 화면 안에 있을 경우 시간이 카운트됩니다!
                    <br>공부가 끝나실 경우 화면 하단의 '종료하기'를 눌러주세요!</span>
    ...
    <script>
      ...
      function ajaxd()  {
        ...
        $("#resultReceived").load("http://localhost/sendResult")
        received = $("#resultReceived").val();
        object = received.split(',');
        object.splice(object.length -1);
        console.log(object);
        hands = object.includes('hand');
