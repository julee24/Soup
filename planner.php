<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        if (empty($task)){
            ...
            mysqli_query($con,"INSERT INTO todolist(id, todo, checklist) values ('$id','$task','F')");
    ...
    if(isset($_GET['del_task'])) {
        $num = $_GET['del_task'];
        mysqli_query($con, "DELETE FROM todolist where id='$id' and num='$num'");
    }
    $today = date('Y/m/d');

    $tasks = mysqli_query($con, "SELECT * FROM todolist where id='$id' and today='$today'");
?>
<!DOCTYPE html>
<html class="html__responsive " lang="en">
	...
	<body>
                ...
                <div class="planInput">
                    <div class="inputform">
                        ...
                        <?php if (isset($errors)) {?>
                            <p><?php echo $errors; ?></p>
                        <?php }?>
                            <input type="text" name="task" placeholder="일정을 입력해주세요" required>
                            <button type="submit" class="button" name="submit">추가하기</button>
                        </form>
                    </div>
                </div>
                <div class="todo">
        ...
        <script src="js/planner.js?ver=1"></script>
	</body>
