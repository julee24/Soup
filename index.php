        ...
        <main class="main">
            <div class="header-box">
                <div class="content-header-box">
                    <div class="header-box-content">
                        <h1>안녕하세요! 스프로 오신 것을 환영합니다.</h1><h1 class="highlight">스프랑 함께 공부해봐요!</h1>
                        <br><br><span>스프만의 집중 시스템으로 원하는 목표를 달성해요!<br></span>
                        <a href="study.php" class="button" id="content-button">공부하러 가기  →</a>
                    </div>
                    <img class="banner-pc-image" src="img/header.svg">            
                </div>
            </div>           
            <div class="responsive-wrapper">
                <div class="content">
                    ...
                    // $id=$_SESSION['id'];
                    $connect = mysqli_connect("localhost","root","yewwey1105","newdb") or die ("Can't access DB");
                    $sql= "SELECT * from diary where text IS NOT NULL order by rand() limit 6";
                    $confirmrow = mysqli_query($connect, $sql);             
                    // $array = mysqli_fetch_array($confirm);
                    // $g_date = $array['studydate'];
                    // $g_time = $array['studytime'];
                    while($row = mysqli_fetch_array($confirmrow))
                    {   
                        $dateArray = $row['writetime'];
                        $modalWrite = explode(" ", $dateArray);
                        ...
                        $inthour =(int)$hour;
                        $cardcontent = $row['text'];
                        $cardimage = $row['photo'];
                        $userid = $row['id'];
                        $con = mysqli_connect("localhost","root","yewwey1105","newdb") or die ("Can't access DB");
                        $query= "SELECT * from users where id='$userid'";
                        $conf = mysqli_query($con, $query);             
                        mysqli_close($con);
                        $carduser = mysqli_fetch_array($conf);
                        $cardProfile = $carduser['profile'];
                        $cardname = $carduser['name'];
                ?>
                        <li class="card">
                            <div class="user">
                                <img class="card-photo" src="<?php if ($cardimage){
                                    echo 'data:image/png;base64,'.base64_encode($cardimage).'';
                                } else {
                                ...
                                <div class="user-info">
                                <?php
                                    if ($cardProfile == ''){
                                        echo '<img src="data:image/png;base64,'.$cardProfile.'">';
                                    } else {
                                        echo '<img src="data:image/png;base64,'.base64_encode($cardProfile).'">';
                                    } 
                                ?>
                                <h5><?php echo $cardname;?></h5>
